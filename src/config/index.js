...
import SuperBase from './base.js'
import IntegralMall from './integralMall.js'
export default {
  ...Recycle,
  ...SuperBase,
  ...IntegralMall,
  ...
  tutorial: {
    ...
    RankList: '/activity/tutorial/info/evalute/index',
    RankDel: '/activity/tutorial/info/evalute/delete',
