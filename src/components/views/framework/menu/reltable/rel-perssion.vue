        ...
        <div class="lh-form">
            <kobe-table>
                ...
                <el-table
                    ...
                    <el-table-column prop="display_name" label="权限点名称" width="130"></el-table-column>
                    <el-table-column prop="name" label="权限标识"></el-table-column>
                    <el-table-column prop="description" label="权限说明" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList (data = {}) {
      api.GET(config.frameWorkMenu.related, {
        menu_id: this.menuId,
        ...data
      })
      .then(response => {
    ...
    deleteType (id) {
      ...
      this.$confirm('是否确认移除权限', '提示', {
        ...
        api.POST(config.frameWorkMenu.relDelete, {
