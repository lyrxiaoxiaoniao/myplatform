<template>
  <div class="sc-reservation-foundation-list">
    ...
    <el-dialog title="高级搜索"
               ...
               size="tiny">
      <el-form :model="advanceSearchForm"
      ...
      <div class="dialog-footer"
        ...
        <el-button type="danger"
                   @click="hideDialog('advanceVisible')">取消</el-button>
        <el-button type="primary"
                   @click="advanceSearch">搜索</el-button>
      </div>
    </el-dialog>
    <el-dialog title="添加"
               v-model="infoVisible"
      ...
      <el-tabs type="border-card"
        ...
        <el-tab-pane label="基地说明">
          <vue-html5-editor @change="updateData"
                            :content="content"></vue-html5-editor>
        </el-tab-pane>
      ...
      <div class="dialog-footer"
           slot="footer">
        <el-button type="danger"
                   @click="hideDialog('infoVisible')">取消</el-button>
        <el-button type="primary"
